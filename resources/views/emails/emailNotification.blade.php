...
<div class="row">
    <div class="col-6">
        <strong style="font-size: 20px;">Petto Tomodachi</strong><br>
        <strong style="font-size: 15px;">Brgy Lourdes , Quezon City</strong>
        <br><br><br>
...
<div class="row">
    <div class="col-6">
        ...
        <strong style="font-size: 15px;">Login into the website to more details. https://petto-tomodachii.supsofttech.com/</strong><br><br>
